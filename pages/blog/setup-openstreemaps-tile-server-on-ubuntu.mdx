...
Since this process will take quite a bit of time. It is recommended to run the entire process using a `screen` multiplex session. For a quickie on `screen` please check here. 👈
