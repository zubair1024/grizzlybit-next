...
summary: 'Titans such as Facebook and Google have teamed up to make a faster and better package manager in comparison to npm. It is called Yarn. Though, don’t be alarmed this package management tool takes packages from NpmJS and Bower registries supporting parallel dependency installations...'
image: '/static/images/yarn-on-the-rise/cover.png'
---

![Yarn on the Rise](/static/images/yarn-on-the-rise/cover.png)
